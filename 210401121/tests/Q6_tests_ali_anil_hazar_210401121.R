...
# Q6 Veri Analizi Testleri

# Test 6.1: merged_data veri cercevesinde eksik degerler olup olmadigi kontrol ediliyor.
test_that("6.1 Missing Values Test", {
  expect_false(any(is.na(merged_data)))
})

# Test 6.2: similar_study_time_groups veri cercevesinin beklenen sutunlari iceriyor mu?
...
# Test 6.3: Grafiklerin olusturuldugu surecte hata olup olmadigi kontrol ediliyor.
